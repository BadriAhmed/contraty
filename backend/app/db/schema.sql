-- Contraty Database Schema
-- Run against Supabase PostgreSQL (includes pgvector extension)
...
-- ============================================================
-- Template chunks (for RAG / embedding search)
-- Each template is split into chunks (one per article)
-- ============================================================
