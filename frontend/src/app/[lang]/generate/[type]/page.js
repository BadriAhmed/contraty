...
import { Lock, ArrowRight, ArrowLeft, CheckCircle2, Download, Copy, Loader2, X } from "lucide-react";
...
export default function GeneratePage() {
  ...
  const totalSteps = fieldSteps + 1; // + disclaimer step
  ...
  // Group current fields by section
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3 pt-2">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-primary text-on-primary font-semibold py-3 px-4 rounded-lg hover:bg-surface-tint transition-colors shadow-sm"
                >
                  <Download size={16} />
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-transparent border-2 border-primary text-primary font-semibold py-3 px-4 rounded-lg hover:bg-primary-fixed transition-colors"
                >
                  <Copy size={16} />
              ...
              >
                &larr; {lang === "ar" ? "العودة للنموذج" : "Retour au formulaire"}
              </button>
            </div>
          ) : isDisclaimerStep ? (
            /* Disclaimer step */
            <div className="space-y-6">
              ...
              <div className="flex gap-3 pt-4 border-t border-border-slate">
                ...
                <button
                  ...
                  disabled={generating}
                  className="flex items-center gap-2 bg-primary text-on-primary font-semibold px-5 py-2.5 rounded-lg hover:bg-surface-tint transition-colors shadow-sm disabled:opacity-50"
                >
