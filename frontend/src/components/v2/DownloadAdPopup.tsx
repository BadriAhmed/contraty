        ...
        <div className="p-6 md:p-8">
          ...
          <p className="text-sm text-text-secondary mb-5 text-center">
            {downloadStarted
              ...
              : (lang === "ar" ? "سيبدأ التحميل تلقائيًا خلال لحظات" : "Votre téléchargement va démarrer automatiquement")}
          </p>
          ...
          <div className="mt-5 text-center">
            {downloadStarted ? (
              <button
                onClick={onClose}
                className="inline-flex items-center gap-2 bg-primary text-on-primary font-semibold px-6 py-3 rounded-xl hover:bg-surface-tint transition-colors shadow-sm text-sm"
              >
