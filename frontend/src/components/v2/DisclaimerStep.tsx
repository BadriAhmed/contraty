      ...
      {lang === "ar" && (
        <div className="bg-primary text-on-primary rounded-2xl p-4 md:p-6 mb-4 md:mb-6 shadow-lg shadow-primary/25">
          ...
          <p className="text-sm text-on-primary/90 leading-relaxed">
            تونّسها كيما تحب، بالعربي، بالفرنساوي، ولا حتى بالدارجة
            (مثال: «ismi Ahmed»، «العمارة رقم 5»، «هو يخلص في آخر الشهر»).
            Contrati يحول إجاباتك لصيغ قانونية صحيحة ومريڤلة في العقد النهائي.
          </p>
        </div>
      )}
