    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-surface rounded-2xl border border-outline-variant/40 p-5 md:p-6 mb-4">
        <textarea
          ...
          rows={4}
          className="input-field min-h-[120px] text-base rounded-xl resize-none"
      ...
      <div className="flex items-center gap-3">
        <button
          onClick={onPrevious}
          disabled={generating}
          className="flex items-center gap-1.5 text-sm font-medium text-text-secondary hover:text-on-surface transition-colors px-4 py-3 rounded-xl hover:bg-surface-container disabled:opacity-50"
        >
        ...
        <button
          onClick={onGenerate}
          disabled={generating}
          className="flex-1 flex items-center justify-center gap-2 bg-primary text-on-primary font-semibold py-4 rounded-2xl hover:bg-surface-tint transition-colors shadow-lg shadow-primary/20 disabled:opacity-50 text-base"
        >
